...
hl.bind(vars.mainMod .. " + Z",      hl.dsp.exec_cmd(vars.browser))
...
hl.bind(vars.mainMod .. " + Tab", hl.dsp.focus({ workspace = "e+1" }))
hl.bind(vars.mainMod .. " + SHIFT + Tab",   hl.dsp.focus({ workspace = "e-1" }))
